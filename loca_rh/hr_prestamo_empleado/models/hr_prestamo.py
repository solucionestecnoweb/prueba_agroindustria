...
class SaleOrder(models.Model):
    ...
    status_prestamo=fields.Selection(selection=[('hold','En Espera'),('pending','Pendiente'),('solvent','Solvente')],default='hold',index=True, track_visibility='onchange',readonly=True, copy=False, tracking=True)
    ...
    def cancel(self):
        ...
        if verifica:
            raise ValidationError(_("Este empleado tiene un prestamo ya ejecutado por nomina. No se puede realizar la accion solicitada"))
